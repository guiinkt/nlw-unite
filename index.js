let participantes = [
  {
    nome: "Guilherme Nakata",
    email: "gui.nakata@gmail.com",
    dataInscricao: new Date(2024, 2, 1, 19, 23),
    dataCheckIn: new Date(2024, 2, 1, 20, 20)
  },
  {
    nome: "Larisse Cardoso",
    email: "lari.cardoso@gmail.com",
...
const fazerCheckin = (event) => {
  ...
  const mensagemConfirmacao = 'Tem certeza que deseja efetuar o check-in?'
  ...
  //atualizar a lista de pasrticipantes
  atualizarLista(participantes)
}